...
namespace JESUSISLORDplatformer
{
    ...
    public class ChangingBackgroundState : GameScreen
    {
        ...
        public ChangingBackgroundState()
        {
            ...
            changingbackgroundsrect = new Rectangle(0, 150, 800, 450);

            place = new string[1];

            place[0] = "Islamic Republic of Pakistan";
            title = new string[1];
            title[0] = "Country in South Asia. Capital is Islamabad. Largest City is Karachi.";
             phonenumber = new string[1];
             phonenumber[0] = "The president of Pakistan is Mamnoon Hussain. The prime minister is Mian Nawaz Sharif.";

           website = new string[1];
          website[0] = "Population Exceeding 180 million";
          explination = new string[1];
          explination[0] = "Pakistan is a federal parliamentary republic consisting of four provinces and four federal territories.";
        }
        /// <summary>
       ...
       public override void LoadContent(ContentManager Content)
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
           ...
           // buttonobject.Draw(spriteBatch);
            ...
            spriteBatch.DrawString(spritefont, "3.)" + phonenumber[0], new Vector2(0, 40), Color.White);
            spriteBatch.DrawString(spritefont, "4.)" + website[0], new Vector2(0, 60), Color.White);
            spriteBatch.DrawString(spritefont, "5.)" + explination[0] , new Vector2(0, 80), Color.White);
